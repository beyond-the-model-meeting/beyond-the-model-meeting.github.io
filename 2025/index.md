...
layout: default
permalink: /2025/
page_title: "BTMM 2025"
page_subtitle: "May 4 - 5, 2025, University of Toronto, Toronto, Canada"
page_logo: "/assets/img/2025/UofTlogo.png"
is_archive: true
---
...
![GroupPicture](/assets/img/2025/group_picture.jpg)
...
<table>
  ...
  {% for item in site.data["2025"].participants %}
  <tr>
    <td width="20%">
      {% if item.homelink %}
...
{% for conf_day in site.data["2025"].schedule %}
